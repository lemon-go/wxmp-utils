...
var WxHttpClient = /** @class */ (function (_super) {
    __extends(WxHttpClient, _super);
    function WxHttpClient(logger) {
        var _this = _super.call(this) || this;
        _this.logger = logger;
        return _this;
    }
    WxHttpClient.prototype.send = function (request) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            conf.success = function (_a) {
                ...
                if (statusCode >= 200 && statusCode < 300) {
                    ...
                    var errorMessage = "[WxHttpClient] Request success, but status code is " + statusCode;
